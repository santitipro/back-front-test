...
// Repositories
container.bind<PropertyRepository>('PropertyRepository').to(NetworkPropertyRespository)

// UseCases
container.bind<GetPropertiesUseCase>('GetPropertiesUseCase').to(GetPropertiesUseCase)

// Controllers
container.bind<GetPropertiesController>('GetPropertiesController').to(GetPropertiesController)
